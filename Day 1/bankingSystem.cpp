// Design a cpp program to simulate a banking system using polymorphism.Create a base class account with a virtual method.Calculate interest.Use derived classes savings account and current account to implement specific interest calculation logic
//     Savings account = balance * rate * time No interest but maintenance fee deduction
